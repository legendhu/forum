<%@ page language="java"
	import="java.sql.*,com.xxcyjd.domain.*,java.util.*"
	pageEncoding="UTF-8"%>
							...
							<div class="jive-message-list">
								<div class="jive-table">
									<div class="jive-messagebox">
										...
										<c:forEach items="${kids}" var="a" varStatus="floor">
														...
														<td class="jive-last" width="99%"><table border="0"
																...
																<tbody>
																	<tr valign="top">
																		...
																		<c:if test="${floor.index==0}">
																		<td width="97%"><span class="jive-subject">楼主----${a.title}</span>
																		</td>
																		</c:if>
																		<c:if test="${floor.index > 0 }">
																		<td width="97%"><span class="jive-subject">第${floor.index}楼----${a.title}</span>
																		</td>
																		</c:if>
																					...
																					<tbody>
																						<tr>
																							...
																							<td class="jive-icon"><a
																								href="<%=basePath%>reply.jsp?id=${a.id}&rootId=${a.rootId}"
																								title="回复本主题"><img
																									src="images/reply-16x16.gif" alt="回复本主题"
																									border="0" height="16" width="16"></a></td>
																							<td class="jive-icon-label"><a
																								href="<%=basePath%>reply.jsp?id=${a.id}&rootId=${a.rootId}">回复</a>
																							</td>
																						</tr>
																					</tbody>
																				</table>
																	...
																	<tr>
																		<td colspan="4" style="font-size: 9pt;"><img
																			...
																			color="#568ac2">学程序是枯燥的事情，愿大家在一起能苦中作乐！</font> <br>
																		</td>
																	</tr>
																	<tr>
																		<td colspan="4"
																			style="border-top: 1px solid rgb(204, 204, 204); font-size: 9pt; table-layout: fixed;">
																			·<a href="http://www.xxglxylt.com"><font
																				color="#666666">http://www.xxglxylt.com</font></a>
																		</td>
																	</tr>
																</tbody>
															</table></td>
